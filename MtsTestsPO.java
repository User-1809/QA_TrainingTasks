...
public class MtsTestsPO {
    ...
    public static class MainPage {
        ...
        public int getLogosCount() { return drv.findElements(By.cssSelector(".pay__partners img")).size(); }
        ...
        public String getPlaceholder(String css) { return drv.findElement(By.cssSelector(css)).getAttribute("placeholder"); }
    ...
    public void testMtsPaymentFlow() {
        ...
        Assertions.assertTrue(mainPage.getLogosCount() > 0);
        ...
        String debtPlaceholder = driver.findElement(By.cssSelector("input[id*='debt'], input[placeholder*='счета']")).getAttribute("placeholder");
